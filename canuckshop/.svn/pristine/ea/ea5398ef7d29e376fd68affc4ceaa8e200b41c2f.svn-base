...
class Customerorders extends CI_Controller {
  ...
  public function confirm_customer($clientid = 0, $message = '')
  {
    ...
    $this->form_validation->set_rules('name', 'School', 'trim|required|min_length[3]|max_length[200]');
    ...
    $this->form_validation->set_rules('cellphone', 'Cellphone', 'trim|min_length[8]|max_length[45]');
