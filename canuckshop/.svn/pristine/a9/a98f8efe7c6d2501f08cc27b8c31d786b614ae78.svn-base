...
class Customerorderitems extends CI_Controller {
  ...
  public function select_update_style($clientid = 0, $orderid = 0, $stocks_edit = 0, $artworks_edit = 0, $itemcode = 0, $message = '')
  {
    ...
    //$this->form_validation->set_rules('itemcode', 'Itemcode', 'trim|required|min_length[3]|max_length[45]');
    $this->form_validation->set_rules('styleid', 'StyleId', 'trim|required|min_length[3]|max_length[45]');
    if ($this->session->userdata('uf_logged_in')) {
      $uf_orders = $this->session->userdata('uf_orders');
      $uf_stocks = $this->session->userdata('uf_stocks');
      $uf_uniforms = $this->session->userdata('uf_uniforms');
  ...
  {
    $this->form_validation->set_error_delimiters('<div class="messageStackError">', '</div>');
    $this->form_validation->set_rules('name', 'Name', 'trim|required|min_length[8]|max_length[200]');
    $this->form_validation->set_rules('contact', 'Contact', 'trim|required|min_length[3]|max_length[50]');
    $this->form_validation->set_rules('email', 'Email', 'trim|email|max_length[100]');
    $this->form_validation->set_rules('telephone', 'Telephone', 'trim|required|min_length[12]|max_length[12]|callback_phone_check');
    $this->form_validation->set_rules('cellphone', 'Cellphone', 'trim|max_length[12]|callback_phone_check');
    //$this->form_validation->set_rules('address', 'Address', 'trim|required|min_length[8]|max_length[100]');
    //$this->form_validation->set_rules('zipcode', 'Zipcode', 'trim|required|min_length[3]|max_length[45]');
    $this->form_validation->set_rules('shippingaddr', 'ShippingAddr', 'trim|required|min_length[8]|max_length[100]');
    $this->form_validation->set_rules('shippingzip', 'ShippingZip', 'trim|required|min_length[3]|max_length[45]');
  ...
  public function insert_stock($clientid = 0, $orderid = 0, $stocks_edit = 0, $artworks_edit = 0, $itemcode = '', $styleid = 0, $message = '')
  {
    ...
    $this->form_validation->set_rules('frontlogocolor', 'FrontLogoColor', 'trim|required|min_length[2]|max_length[50]');
    $this->form_validation->set_rules('frontlogotrimcolor', 'FrontLogoTrimColor', 'trim|max_length[50]');
    $this->form_validation->set_rules('frontnumpos', 'FrontNumPos', 'trim|required');
    $this->form_validation->set_rules('frontnumsize', 'FrontNumSize', 'trim|required');
    $this->form_validation->set_rules('frontnumcolor', 'FrontNumColor', 'trim|required|min_length[2]|max_length[50]');
    $this->form_validation->set_rules('frontnumtrimcolor', 'FrontNumTrimColor', 'trim|max_length[50]');

    $this->form_validation->set_rules('rearlogopos', 'RearLogoPos', 'trim|required');
    $this->form_validation->set_rules('rearlogoname', 'RearLogoName', 'trim|max_length[50]');
    $this->form_validation->set_rules('rearlogocolor', 'RearLogoColor', 'trim|required|min_length[2]|max_length[50]');
    $this->form_validation->set_rules('rearlogotrimcolor', 'RearLogoTrimColor', 'trim|max_length[50]');
    $this->form_validation->set_rules('rearnumpos', 'RearNumPos', 'trim|required');
    $this->form_validation->set_rules('rearnumsize', 'RearNumSize', 'trim|required');
    $this->form_validation->set_rules('rearnumcolor', 'RearNumColor', 'trim|required|min_length[2]|max_length[50]');
    $this->form_validation->set_rules('rearnumtrimcolor', 'RearNumTrimColor', 'trim|max_length[50]');

    $this->form_validation->set_rules('shortlogopos', 'ShortLogoPos', 'trim|required');
    $this->form_validation->set_rules('shortnumpos', 'ShortNumPos', 'trim|required');
