...
class Uniformorders extends CI_Controller {
  ...
  public function search($orders_start = 0, $message = 'Search')
  {
    ...
    $this->form_validation->set_rules('orders_what', 'What', 'trim');
    $this->form_validation->set_rules('select_orders_status', 'Status', 'trim');
    $this->form_validation->set_rules('select_query_sort', 'Sort', 'trim');
    $this->form_validation->set_rules('orders_fromdate', 'FromDate', 'trim');
    $this->form_validation->set_rules('orders_todate', 'ToDate', 'trim');
