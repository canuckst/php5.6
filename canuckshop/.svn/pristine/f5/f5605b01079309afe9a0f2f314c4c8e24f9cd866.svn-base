...
<?php echo sprintf('<a href="%s/customerorders/select/%d" title="Previous"><img src="%s/images/icons/icon_previous.gif" height="20px" /></a>'
,WEB_CONTEXT,$clientid,WEB_CONTEXT); ?><br>
...
?>
<img src="<?php echo WEB_CONTEXT;?>/images/icons/icon_save.gif" /><input type="submit" value="Submit to Canuckstuff for Mockup" title="Submit to Canuckstuff for Mockup" />&nbsp;&nbsp;
<?php echo sprintf('<a href="%s/customerorderitems/form_order/%d/%s" title="Edit/Add Items/Artworks"><img src="%s/images/icons/icon_edit_pen.gif" height="20px" /></a>'
,WEB_CONTEXT,$clientid,$orderid,WEB_CONTEXT); ?>
<?php 
} else if ($order->orderstatus == '1') {
?>
<img src="<?php echo WEB_CONTEXT;?>/images/icons/icon_save.gif" /><input type="submit" value="Confirm to Canuckstuff for Printing" title="Confirm to Canuckstuff for Printing" />&nbsp;&nbsp;
<?php echo sprintf('<a href="%s/customerorderitems/form_order/%d/%s" title="Edit/Add Items/Artworks"><img src="%s/images/icons/icon_edit_pen.gif" height="20px" /></a>'
,WEB_CONTEXT,$clientid,$orderid,WEB_CONTEXT); ?>
...
<!-- add feedback -->
<?php echo form_open('customerorderitems/insert_feedback/'.$clientid.'/'.$orderid); ?>
...
<tr class="rowEven"><td>Email</td><td><?php echo $order->email; ?></td><td>Date Ordered</td><td><?php echo substr($order->orderdate,0,10); ?></td></tr>
...
<br/>
<?php 
$add_item_button = sprintf('<a href="%s/customerorderitems/form_insert_order/%d/%s/%d" title="Client Order Item - Add"><img src="%s/images/buttons/button_add.jpg" width="60" /></a>'
	,WEB_CONTEXT,$clientid,$orderid,0,WEB_CONTEXT);
...
<?php echo sprintf('<a href="%s/customerorderitems/form_update_order/%d/%s/%d" title="Client Order Item - Edit"><img src="%s/images/buttons/small_edit.gif" /></a>'
              ,WEB_CONTEXT,$clientid,$orderid,$row->stockid,WEB_CONTEXT); ?>&nbsp;&nbsp;
...
foreach($artworks->result() as $artwork) {
  $edit_artwork = sprintf('<a href="%s/customerrderitems/form_update_order/%d/%s/%d/%d" title="Client Order Artwork - Edit"><img src="%s/images/buttons/small_edit.gif" /></a>'
      ,WEB_CONTEXT,$clientid,$orderid,0,$artwork->artworkid,WEB_CONTEXT);
...
<?php echo form_open_multipart('customerorderitems/insert_artwork/'.$clientid.'/'.$orderid); ?>
File(max 2m): <input type="file" name="filename" size="20" />&nbsp;
From: <?php echo $order->contact; ?> &nbsp;&nbsp;
Type: <?php echo form_dropdown('artworkstatus', $artworkstatus_list, '', $artworkstatus_options); ?>&nbsp;
Comment: <input type="text" name="comment" value="" size="25" maxlength="100" />&nbsp;<br/>
<img src="<?php echo WEB_CONTEXT;?>/images/icons/icon_save.gif" /><input type="submit" value="Add New Artwork" title="Add New Artwork" />
<?php echo form_close(); ?>
