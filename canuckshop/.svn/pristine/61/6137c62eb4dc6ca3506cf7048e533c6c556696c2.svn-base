...
$file = '/home/canuckst/public_html/sitemap1.xml';
//$date = $argv[1];
$date = date('Y-m-d');
...
if ($file)
{
	...
	fwrite($fh, "<url>\n");
	fwrite($fh, "  <loc>http://www.canuckstuff.com/</loc>\n");
	fwrite($fh, "  <lastmod>{$date}</lastmod>\n");
	fwrite($fh, "  <changefreq>weekly</changefreq>\n");
	fwrite($fh, "  <priority>1.00</priority>\n");
	fwrite($fh, "</url>\n");
	fwrite($fh, "<url>\n");
	fwrite($fh, "  <loc>http://www.canuckstuff.com/store/</loc>\n");
	fwrite($fh, "  <lastmod>{$date}</lastmod>\n");
	fwrite($fh, "  <changefreq>weekly</changefreq>\n");
	fwrite($fh, "  <priority>1.00</priority>\n");
	fwrite($fh, "</url>\n");
	fwrite($fh, "<url>\n");
	fwrite($fh, "  <loc>http://www.canuckstuff.com/store/index.php?main_page=page&amp;id=15&amp;chapter=30</loc>\n");
	fwrite($fh, "  <lastmod>{$date}</lastmod>\n");
	fwrite($fh, "  <changefreq>weekly</changefreq>\n");
	...
	fwrite($fh, "<url>\n");
	fwrite($fh, "  <loc>http://www.canuckstuff.com/store/index.php?main_page=page&amp;id=16&amp;chapter=40</loc>\n");
	fwrite($fh, "  <lastmod>{$date}</lastmod>\n");
	fwrite($fh, "  <changefreq>weekly</changefreq>\n");
	fwrite($fh, "  <priority>0.50</priority>\n");
	fwrite($fh, "</url>\n");
	...
	fwrite($fh, "<url>\n");
	fwrite($fh, "  <loc>http://www.canuckstuff.com/store/index.php?main_page=page&amp;id=18&amp;chapter=43</loc>\n");
	fwrite($fh, "  <lastmod>{$date}</lastmod>\n");
	fwrite($fh, "  <changefreq>weekly</changefreq>\n");
	fwrite($fh, "  <priority>0.50</priority>\n");
	fwrite($fh, "</url>\n");
	...
	fwrite($fh, "<url>\n");
	fwrite($fh, "  <loc>http://www.canuckstuff.com/store/index.php?main_page=page&amp;id=19&amp;chapter=46</loc>\n");
	fwrite($fh, "  <lastmod>{$date}</lastmod>\n");
	fwrite($fh, "  <changefreq>weekly</changefreq>\n");
	fwrite($fh, "  <priority>0.50</priority>\n");
	fwrite($fh, "</url>\n");
	...
	fwrite($fh, "<url>\n");
	fwrite($fh, "  <loc>http://www.canuckstuff.com/store/index.php?main_page=page&amp;id=17&amp;chapter=50</loc>\n");
	fwrite($fh, "  <lastmod>{$date}</lastmod>\n");
	fwrite($fh, "  <changefreq>weekly</changefreq>\n");
	fwrite($fh, "  <priority>0.50</priority>\n");
	fwrite($fh, "</url>\n");
	...
	fwrite($fh, "<url>\n");
	fwrite($fh, "  <loc>http://www.canuckstuff.com/store/index.php?main_page=contact_us</loc>\n");
	fwrite($fh, "  <lastmod>{$date}</lastmod>\n");
	fwrite($fh, "  <changefreq>weekly</changefreq>\n");
	fwrite($fh, "  <priority>0.50</priority>\n");
	fwrite($fh, "</url>\n");
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		fwrite($fh, "<url>\n");
		fwrite($fh, "<loc>http://www.canuckstuff.com/store/index.php?main_page=index&amp;cPath={$id}</loc>\n");
		fwrite($fh, "<lastmod>{$date}</lastmod>\n");
		fwrite($fh, "<changefreq>weekly</changefreq>\n");
		fwrite($fh, "<priority>1.00</priority>\n");
		fwrite($fh, "</url>\n");
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		fwrite($fh, "<url>\n");
		fwrite($fh, "<loc>http://www.canuckstuff.com/store/index.php?main_page=index&amp;cPath={$cp1}_{$cp2}</loc>\n");
		fwrite($fh, "<lastmod>{$date}</lastmod>\n");
		fwrite($fh, "<changefreq>weekly</changefreq>\n");
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		fwrite($fh, "<url>\n");
		fwrite($fh, "<loc>http://www.canuckstuff.com/store/index.php?main_page=index&amp;cPath={$cp1}_{$cp2}_{$cp3}</loc>\n");
		fwrite($fh, "<lastmod>{$date}</lastmod>\n");
		fwrite($fh, "<changefreq>weekly</changefreq>\n");
		fwrite($fh, "<priority>0.80</priority>\n");
		fwrite($fh, "</url>\n");
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		fwrite($fh, "<url>\n");
		fwrite($fh, "<loc>http://www.canuckstuff.com/store/index.php?main_page=product_info&amp;cPath={$cats_path}&amp;products_id={$id}</loc>\n");
		fwrite($fh, "<lastmod>{$date}</lastmod>\n");
		fwrite($fh, "<changefreq>weekly</changefreq>\n");
		fwrite($fh, "<priority>0.50</priority>\n");
		fwrite($fh, "</url>\n");
