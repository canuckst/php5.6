...
class Uniformclients extends CI_Controller {
  ...
  public function search($clients_start = 0, $message = '')
  {
    ...
    $this->form_validation->set_rules('clients_what', 'What', 'trim');
  ...
  public function update($clients_start = 0, $clients_edit = 0, $messsage = '')
  {
    ...
    $this->form_validation->set_rules('name', 'School', 'trim|max_length[100]');
    $this->form_validation->set_rules('team', 'Team', 'trim|max_length[100]');
    //$this->form_validation->set_rules('email', 'Email', 'trim|valid_email|max_length[100]');
    $this->form_validation->set_rules('telephone', 'Telephone', 'trim|required|min_length[10]|max_length[45]');
    $this->form_validation->set_rules('cellphone', 'Cellphone', 'trim|max_length[45]');
    $this->form_validation->set_rules('fax', 'Fax', 'trim|max_length[45]');
    $this->form_validation->set_rules('street', 'Street', 'trim|max_length[100]');
    $this->form_validation->set_rules('city', 'City', 'trim|max_length[45]');
    $this->form_validation->set_rules('province', 'Province', 'trim|max_length[45]');
  ...
  public function insert($clients_start = 0, $clients_edit = 0, $messsage = '')
  {
    ...
    $this->form_validation->set_rules('team', 'Team', 'trim|max_length[100]');
    //$this->form_validation->set_rules('email', 'Email', 'trim|valid_email|max_length[100]');
    $this->form_validation->set_rules('telephone', 'Telephone', 'trim|required|min_length[10]|max_length[45]|callback_phone_check');
    $this->form_validation->set_rules('cellphone', 'Cellphone', 'trim');
    $this->form_validation->set_rules('fax', 'Fax', 'trim|min_length[10]|max_length[45]');
    $this->form_validation->set_rules('street', 'Street', 'trim|max_length[100]');
    $this->form_validation->set_rules('city', 'City', 'trim|max_length[45]');
    $this->form_validation->set_rules('province', 'Province', 'trim|max_length[45]');
    $this->form_validation->set_rules('zipcode', 'Zipcode', 'trim|max_length[45]');
