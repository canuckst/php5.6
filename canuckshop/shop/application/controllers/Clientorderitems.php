...
class Clientorderitems extends CI_Controller {
  ...
  public function select_update_item($clients_start = 0, $clientid = 0, $orderid = 0, $stocks_edit = 0, $artworks_edit = 0, $message = '')
  {
    ...
    $this->form_validation->set_rules('itemcode', 'ItemCode', 'trim|required|min_length[3]|max_length[12]|');
  ...
  {
    $this->form_validation->set_error_delimiters('<div class="messageStackError">', '</div>');
    $this->form_validation->set_rules('styleid', 'StyleId', 'trim|required|min_length[1]|max_length[45]|');
  ...
  {
    $this->form_validation->set_error_delimiters('<div class="messageStackError">', '</div>');
    $this->form_validation->set_rules('name', 'Name', 'trim|max_length[200]|');
    ...
    $this->form_validation->set_rules('telephone', 'Telephone', 'trim|required|min_length[8]|max_length[45]|');
    $this->form_validation->set_rules('cellphone', 'Cellphone', 'trim|max_length[45]|');
    $this->form_validation->set_rules('address', 'Address', 'trim|max_length[100]|');
    $this->form_validation->set_rules('zipcode', 'Zipcode', 'trim|max_length[45]|');
    $this->form_validation->set_rules('shippingaddr', 'ShippingAddr', 'trim|max_length[100]|');
    $this->form_validation->set_rules('shippingzip', 'ShippingZip', 'trim|max_length[45]|');
    $this->form_validation->set_rules('orderdate', 'Requireddate', 'trim|required|date|');
    $this->form_validation->set_rules('requireddate', 'Requireddate', 'trim|required|date|');
    $this->form_validation->set_rules('payment', 'Payment', 'trim|max_length[45]|');
    $this->form_validation->set_rules('expdate', 'Expdate', 'trim|max_length[45]|');
  ...
  public function insert_item($clients_start = 0, $clientid = 0, $orderid = 0, $stocks_edit = 0, $artworks_edit = 0, $itemcode = '', $styleid = 0, $message = '')
  {
    ...
    $this->form_validation->set_rules('frontlogopos', 'FrontLogoPos', 'trim|required|');
    $this->form_validation->set_rules('frontlogoname', 'FrontLogoName', 'trim|max_length[50]|');
    $this->form_validation->set_rules('frontlogocolor', 'FrontLogoColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('frontlogotrimcolor', 'FrontLogoTrimColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('frontnumpos', 'FrontNumPos', 'trim|');
    $this->form_validation->set_rules('frontnumsize', 'FrontNumSize', 'trim|');
    $this->form_validation->set_rules('frontnumcolor', 'FrontNumColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('frontnumtrimcolor', 'FrontNumTrimColor', 'trim|max_length[50]|');

    $this->form_validation->set_rules('rearlogopos', 'RearLogoPos', 'trim|');
    $this->form_validation->set_rules('rearlogoname', 'RearLogoName', 'trim|max_length[50]|');
    $this->form_validation->set_rules('rearlogocolor', 'RearLogoColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('rearlogotrimcolor', 'RearLogoTrimColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('rearnumpos', 'RearNumPos', 'trim|');
    $this->form_validation->set_rules('rearnumsize', 'RearNumSize', 'trim|');
    $this->form_validation->set_rules('rearnumcolor', 'RearNumColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('rearnumtrimcolor', 'RearNumTrimColor', 'trim|max_length[50]|');

    $this->form_validation->set_rules('shortlogopos', 'ShortLogoPos', 'trim|');
    $this->form_validation->set_rules('shortlogocolor', 'ShortLogoColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('shortlogotrimcolor', 'ShortLogoTrimColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('shortnumpos', 'ShortNumPos', 'trim|');
    $this->form_validation->set_rules('shortnumsize', 'ShortNumSize', 'trim|');
    $this->form_validation->set_rules('shortnumcolor', 'ShortNumColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('shortnumtrimcolor', 'ShortNumTrimColor', 'trim|max_length[50]|');

    $this->form_validation->set_rules('xsmall', 'Xsmall', 'trim|numeric|');
    $this->form_validation->set_rules('xsmallnumbers', 'XsmallNumbers', 'trim|max_length[250]|');

    $this->form_validation->set_rules('small', 'Small', 'trim|numeric|');
    $this->form_validation->set_rules('smallnumbers', 'SmallNumbers', 'trim|max_length[250]|');

    $this->form_validation->set_rules('medium', 'Medium', 'trim|numeric|');
    $this->form_validation->set_rules('mediumnumbers', 'MediumNumbers', 'trim|max_length[250]|');

    $this->form_validation->set_rules('large', 'Large', 'trim|numeric|');
    $this->form_validation->set_rules('largenumbers', 'LargeNumbers', 'trim|max_length[250]|');

    $this->form_validation->set_rules('xlarge', 'Xlarge', 'trim|numeric|');
    $this->form_validation->set_rules('xlargenumbers', 'XlargeNumbers', 'trim|max_length[250]|');

    $this->form_validation->set_rules('xxlarge', 'Xxlarge', 'trim|numeric|');
    $this->form_validation->set_rules('xxlargenumbers', 'XxlargeNumbers', 'trim|max_length[250]|');
  ...
  public function update_status($clients_start = 0, $clientid = 0, $orderid = 0, $message = '')
  {
    ...
    $this->form_validation->set_rules('updcomment', 'UpdComment', 'trim|max_length[100]|');
  ...
  {
    $this->form_validation->set_error_delimiters('<div class="messageStackError">', '</div>');
    $this->form_validation->set_rules('artworksource', 'ArtworkSource', 'trim|');
    $this->form_validation->set_rules('artworkstatus', 'ArtworkStatue', 'trim|');
    $this->form_validation->set_rules('comment', 'Comment', 'trim|max_length[100]|');
  ...
  {
    $this->form_validation->set_error_delimiters('<div class="messageStackError">', '</div>');
    $this->form_validation->set_rules('itemcode', 'ItemCode', 'trim|required|max_length[45]|');
    $this->form_validation->set_rules('styleid', 'StyleId', 'trim|');

    $this->form_validation->set_rules('description', 'Description', 'trim|max_length[250]|');

    $this->form_validation->set_rules('frontlogopos', 'FrontLogoPos', 'trim|');
    $this->form_validation->set_rules('frontlogoname', 'FrontLogoName', 'trim|max_length[50]|');
    $this->form_validation->set_rules('frontlogocolor', 'FrontLogoColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('frontlogotrimcolor', 'FrontLogoTrimColor', 'trim|max_length[50]|');
    $this->form_validation->set_rules('frontnumpos', 'FrontNumPos', 'trim|');
  ...
  {
    $this->form_validation->set_error_delimiters('<div class="messageStackError">', '</div>');
    $this->form_validation->set_rules('feedback', 'Feedback', 'trim|required|min_length[2]|max_length[250]');
